...
export default class AuthenticationApi {
    ...
    */
     ...
     * @param {module:model/ServiceAuthenticators} authenticator The authenticator to update
     * @param {String} account Organization account name
     * @param {Object} opts Optional parameters
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     ...
     * @param {String} body API Key
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.acceptEncoding Setting the Accept-Encoding header to base64 will return a pre-encoded access token (default to 'application/json')
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     ...
     * @param {String} serviceId URL-Encoded authenticator service ID
     * @param {String} account Organization account name
     * @param {String} login URL-encoded login name. For hosts, the login name is `host/<host-id>`
     ...
     * @param {String} account Organization account name
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.acceptEncoding Setting the Accept-Encoding header to base64 will return a pre-encoded access token
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     * @param {String} opts.jwt 
     ...
     * @param {module:model/String} opts.acceptEncoding Setting the Accept-Encoding header to base64 will return a pre-encoded access token (default to 'application/json')
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     * @param {String} opts.body API key
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.hostIdPrefix Dot-separated policy tree, prefixed by `host.`, where the application identity is defined
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     ...
     * @param {String} account Organization account name
     * @param {Object} opts Optional parameters
     * @param {String} opts.role (**Optional**) role specifier in `{kind}:{identifier}` format  ##### Permissions required  `update` privilege on the role whose API key is being rotated. 
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
