...
export default class CertificateAuthorityApi {
    ...
    */
     ...
     * @param {module:model/CertificateJson} data The data returned by the service call.
     ...
     * @param {String} opts.accept Setting the Accept header to `application/x-pem-file` allows Conjur to respond with a formatted certificate
     ...
     * data is of type: {@link module:model/CertificateJson}
     */
    sign(account, serviceId, csr, ttl, opts, callback) {
      ...
      let returnType = CertificateJson;
