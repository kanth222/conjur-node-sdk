...
export default class SecretsApi {
    ...
    */
     ...
     * @param {String} opts.expirations Tells the server to reset the variables expiration date
     ...
     * @param {String} opts.body Secret data
     ...
     * @param {String} identifier URL-encoded variable ID
     * @param {Object} opts Optional parameters
     * @param {Number} opts.version (**Optional**) Version you want to retrieve (Conjur keeps the last 20 versions of a secret)
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.acceptEncoding Set the encoding of the response object
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
