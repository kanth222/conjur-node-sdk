...
export default class RolesApi {
    ...
    */
     ...
     * @param {String} identifier ID of the role for which to get the information about
     * @param {Object} opts Optional parameters
     * @param {String} opts.all Returns an array of Role IDs representing all role memberships, expanded recursively.
     * @param {String} opts.memberships Returns all direct role memberships (members not expanded recursively).
     * @param {String} opts.members Returns a list of the Role's members.
     * @param {Number} opts.offset When listing members, start at this item number.
     * @param {Number} opts.limit When listing members, return up to this many results.
     * @param {Boolean} opts.count When listing members, if `true`, return only the count of members.
     * @param {String} opts.search When listing members, the results will be narrowed to only those matching the provided string
     * @param {String} opts.graph If included in the query returns a graph view of the role
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
