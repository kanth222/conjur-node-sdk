...
export default class ResourcesApi {
    ...
    */
     ...
     * @param {Boolean} opts.permittedRoles Lists the roles which have the named privilege on a resource.
     * @param {String} opts.privilege Level of privilege to filter on. Can only be used in combination with `permitted_roles` or `check` parameter.
     * @param {Boolean} opts.check Check whether a role has a privilege on a resource.
     * @param {String} opts.role Role to check privilege on. Can only be used in combination with `check` parameter.
     ...
     * @param {String} account Organization account name
     * @param {Object} opts Optional parameters
     * @param {String} opts.kind Type of resource
     * @param {String} opts.search Filter resources based on this value by name
     * @param {Number} opts.offset When listing resources, start at this item number.
     * @param {Number} opts.limit When listing resources, return up to this many results.
     * @param {Boolean} opts.count When listing resources, if `true`, return only the count of the results.
     * @param {String} opts.role Retrieves the resources list for a different role if the authenticated role has access
     * @param {String} opts.actingAs Retrieves the resources list for a different role if the authenticated role has access
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.account Organization account name
     * @param {String} opts.kind Type of resource
     * @param {String} opts.search Filter resources based on this value by name
     * @param {Number} opts.offset When listing resources, start at this item number.
     * @param {Number} opts.limit When listing resources, return up to this many results.
