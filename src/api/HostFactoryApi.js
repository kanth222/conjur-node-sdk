...
export default class HostFactoryApi {
    ...
    */
     ...
     * @param {module:model/CreateHost} data The data returned by the service call.
     ...
     * @param {Object} opts.annotations Annotations to apply to the new host
     ...
     * data is of type: {@link module:model/CreateHost}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.xRequestId Add an ID to the request being made so it can be tracked in Conjur. If not provided the server will automatically generate one. 
     * @param {Array.<String>} opts.cidr Number of host tokens to create
     * @param {Number} opts.count Number of host tokens to create
