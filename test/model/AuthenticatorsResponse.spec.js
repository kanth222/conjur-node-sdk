...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Conjur.AuthenticatorsResponse();
  });
  ...
  describe('AuthenticatorsResponse', function() {
    it('should create an instance of AuthenticatorsResponse', function() {
      // uncomment below and update the code to test AuthenticatorsResponse
      //var instane = new Conjur.AuthenticatorsResponse();
      //expect(instance).to.be.a(Conjur.AuthenticatorsResponse);
    });
